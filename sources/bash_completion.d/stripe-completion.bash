...
_stripe_account_links_create()
{
    ...
    local_nonpersistent_flags+=("--expand=")
    flags+=("--failure-url=")
    two_word_flags+=("--failure-url")
    local_nonpersistent_flags+=("--failure-url=")
    flags+=("--idempotency=")
    two_word_flags+=("--idempotency")
    two_word_flags+=("-i")
    local_nonpersistent_flags+=("--idempotency=")
...
_stripe_invoices_create()
{
    ...
    local_nonpersistent_flags+=("--subscription=")
    flags+=("--tax-percent=")
    two_word_flags+=("--tax-percent")
    local_nonpersistent_flags+=("--tax-percent=")
    flags+=("--api-key=")
    two_word_flags+=("--api-key")
    flags+=("--color=")
    two_word_flags+=("--color")
...
_stripe_invoices_upcoming()
{
    ...
    flags+=("--subscription-prorate=")
    two_word_flags+=("--subscription-prorate")
    local_nonpersistent_flags+=("--subscription-prorate=")
    ...
    flags+=("--subscription-tax-percent=")
    two_word_flags+=("--subscription-tax-percent")
    local_nonpersistent_flags+=("--subscription-tax-percent=")
...
_stripe_listen()
{
    ...
    flags+=("--live")
    local_nonpersistent_flags+=("--live")
    flags+=("--load-from-webhooks-api")
    flags+=("-a")
    local_nonpersistent_flags+=("--load-from-webhooks-api")
    flags+=("--print-json")
    flags+=("-j")
    local_nonpersistent_flags+=("--print-json")
    flags+=("--skip-verify")
...
_stripe_payment_intents_confirm()
{
    ...
    two_word_flags+=("--return-url")
    local_nonpersistent_flags+=("--return-url=")
    flags+=("--save-payment-method=")
    two_word_flags+=("--save-payment-method")
    local_nonpersistent_flags+=("--save-payment-method=")
